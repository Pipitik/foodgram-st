...
__Приведённые ниже команды следует выполнять в директории infra/.__

При необходимости измените файл .env:
```.env
SECRET_KEY="..."                                            # Вставьте свой ключ (get_random_secret_key()).
POSTGRES_USER="postgres"                                    # Логин для подключения к базе данных.
POSTGRES_PASSWORD="supersecretpassword"                     # Пароль для подключения к базе данных.
POSTGRES_DB=foodgram-db                                     # Имя базы данных.
DB_HOST=db                                                  # Название контейнера.
DB_PORT=5432                                                # Порт для подключения к базе данных.
ALLOWED_HOSTS="localhost 127.0.0.1 backend"                 # Список сайтов, с которыми Django может устанавливать соединение и принимать запросы.
CSRF_TRUSTED_ORIGINS="http://localhost http://127.0.0.1"    # Белый список, который указывает исходные данные (домены или поддомены), из которых Django будет доверять входящим запросам с токенами CSRF.
```
